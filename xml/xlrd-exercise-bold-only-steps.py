...
for row_idx in range(first_sheet.nrows):
    ...
    print 'Str_id: ', text_cell_id + ' -- ' + 'Cell value: ', text_cell + ' -- ' + 'XF object: ', text_cell_xf
    ...
    if text_cell_runlist:
        ...
        for segment_idx in range(len(text_cell_runlist)):
            ...
            print 'Cue-s position: ', segment_text
            ...
            print 'Segment text: ', segment_text #a model could be to isolate the 3 values with 0 following them
