...
def clean_str(string):
    #remove characters that would cause decoding errors when writing to CSV
...
def to_csv(tweets):
    with open('tweets-amazingly.csv', 'wb') as f: 
        ...
        for id_nmbr, tweet in enumerate(tweets):
            ...
            writer.writerow([id_nmbr+1, tweet['id_str'], text])
